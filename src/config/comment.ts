...
import { commentGetManyUrl, commentGetSingleUrl, commentCreateUrl, commentUpdateUrl, commentRemoveUrl,
  commentGetManyForManyUrl
} from './';
import API, {  config } from './api';

export const postSearchManyComments = (body: ICommentSearch): AxiosPromise => API.post(commentGetManyUrl, body);
export const postSearchManyForManyComments = (body: { allRequests: ICommentSearch[] }): AxiosPromise => API.post(commentGetManyForManyUrl, body);
